"""
Nonlinear set-redundancy probe v2 (robust).   python probe_nonlinear2.py <model>
...
tag=MODEL.split("/")[-1]; OUT=f"/work/hdd/bdjd/hypergraph_pruning/probe_nonlinear2_{tag}.txt"
...
lg(f"NONLINEAR set-redundancy v2 (PCA-init residual AE)  MODEL={MODEL}  layers={LAYERS}")
